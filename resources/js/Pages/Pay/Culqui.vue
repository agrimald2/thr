                        ...
                        >
                            ...
                            <div class="flex flex-row justify-between">
                                ...
                                <div class="">
                                    ...
                                    <span v-if="cardData.expired.month !== ''"
                                        >/</span
                                    >
...
export default {
    ...
    mounted() {
        this.$nextTick(() => {
            ...
            script.onload = () => {
                document.addEventListener("payment_event", (e) => {
                    if (Culqi.token) {
                        let token = Culqi.token.id;
                        console.log("Se ha creado un token:" + token);
                        // Aquí puedes usar el token para realizar el cargo con tu backend
                    } else {
    ...
    methods: {
        async createCulqui() {
            try {
                ...
                //     "pk_test_f1557f2f26c65043",
                //     config
                // ); // Use the publicKey prop
                Culqi.publicKey = "pk_test_f1557f2f26c65043";
                Culqi.settings({
                    title: "Culqi Store",
                    currency: "PEN",
                    amount: 1000,
        ...
        showError(text) {
            (this.haveError = true), (this.errorText = text);
        },
        handleCloseModal() {
